            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
               ...
               <div className="space-y-6 gradient-border p-6 card-hover rounded-xl transition-transform duration-300 hover:scale-105">
                  ...
                  <div className="flex flex-col justify-center items-center gap-6">
                     ...
                     className="flex items-center gap-3 border border-muted-foreground/30 hover:border-blue-400 transition-all duration-300 rounded-xl px-6 py-4 bg-white/5 hover:bg-white/10 hover:shadow-[0_0_20px_rgba(96,165,250,0.5)] w-full md:w-3/4"
                     >
                     ...
                     target="_blank"
                     rel="noopener noreferrer"
                     className="flex items-center gap-3 border border-muted-foreground/30 hover:border-yellow-400 transition-all duration-300 rounded-xl px-6 py-4 bg-white/5 hover:bg-white/10 hover:shadow-[0_0_20px_rgba(250,204,21,0.5)] w-full md:w-3/4"
                     >
